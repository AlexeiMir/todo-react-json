...
const Task = ({id,text,list,onRemove,onEdite,onComplete,completed}) => {

    const onCompletChange = (e) => {
    ...
    return (<div key={id} className="tasks__items-row">
            <div className="checkbox">
                <input onChange={onCompletChange} type="checkbox" id={`task-${id}`} checked={completed}/>
            ...
            <div className="tasks__items-row-actions">
                <div onClick={() => onEdite(list.id,{id,text})}>
                    <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
